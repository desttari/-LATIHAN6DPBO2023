...
public class Controller extends KeyAdapter implements KeyListener
{
    ...
    public synchronized void keyPressed(KeyEvent e)
    {
        ...
        if(game.isRunning())
        {
            ...
            GameObject temp = handler.get(i); boolean keyProcessed = false;
            if((key == KeyEvent.VK_W) || (key == KeyEvent.VK_UP))
            {
                // Move up.
                temp.setVelY(-5);
                if (lastKeyPressed != KeyEvent.VK_W && lastKeyPressed != KeyEvent.VK_UP) {
            ...
            if((key == KeyEvent.VK_S) || (key == KeyEvent.VK_DOWN))
            {
                // Move down.
                temp.setVelY(+5);
                if (lastKeyPressed != KeyEvent.VK_S && lastKeyPressed != KeyEvent.VK_DOWN) {
            ...
            {
                // Move right.temp.setVelX(+5);
                temp.setVelX(+5);
                if (lastKeyPressed != KeyEvent.VK_D && lastKeyPressed != KeyEvent.VK_RIGHT) {
            ...
            // Jika salah satu tombol WASD ditekan, tambahkan skor.
            if (keyProcessed) {
